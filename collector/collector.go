...
func NewPostfixCollector() *postfixCollector {
	return &postfixCollector{
		...
		activeCount: prometheus.NewDesc("postfix_active_message_count",
			"Number of messages in active queue",
			nil, nil,
		),
		activeSize: prometheus.NewDesc("postfix_active_message_size",
			"Total size of messages in active queue",
			nil, nil,
		),
		deferCount: prometheus.NewDesc("postfix_defer_message_count",
			"Number of messages in defer queue",
			nil, nil,
		),
		deferSize: prometheus.NewDesc("postfix_defer_message_size",
